...
class CI_Template {
   ...
   function my_add_js($script_file, $view_data=null)
   {
      $success = TRUE;
      $js = NULL;
      ...
      $uri = '../../assets/js/'.$script_file;
      $inside = $this->CI->load->view($uri,$view_data,true);
   ...
   function my_add_js_2($script_file){
    $success = TRUE;
    $js = NULL;

    $js = '<script type="text/javascript" src="'. $script_file .'"';
    $js .= "></script>";
